...
const benefits = [
  ...
  { icon: <FileText className="h-5 w-5" />, title: 'Запросы и сравнение предложений', desc: 'Создание запросов, автоматический сбор предложений и табличное сравнение цен, сроков и условий поставки.' },
...
const steps = [
  ...
  { num: '02', title: 'Сравните предложения', desc: 'Получите коммерческие предложения от нескольких поставщиков, сравните цены, НДС, сроки и остатки в одной таблице.' },
    ...
    <div className="min-h-screen bg-card">
      ...
      <section className="mx-auto max-w-4xl px-8 py-24 text-center">
        ...
        <p className="mt-5 text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          EcaMarket — платформа для промышленных закупок. Запросы, сравнение коммерческих предложений, управление заказами, отгрузки и документооборот — всё в одной системе.
        </p>
      ...
      <section className="mx-auto max-w-5xl px-8 pb-20">
        <div className="grid grid-cols-3 gap-5">
          {[
            ...
            { title: 'Сравнение предложений', desc: 'До 10 предложений на один запрос. Табличное сравнение цен, сроков, остатков и условий НДС', link: '/buyer/rfq' },
            { title: 'Панель поставщика', desc: 'Управление прайсами, ответы на запросы покупателей, контроль отгрузок и планирование маршрутов доставки', link: '/supplier' },
          ].map((c, i) => (
